      ...
      <div className="container mx-auto max-w-4xl px-4 py-10 md:py-16">
        ...
        <article className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-2xl shadow-violet-500/5 md:p-10">
          <header className="mb-8 border-b border-slate-800 pb-6">
            ...
            <h1 className="text-3xl font-black tracking-tight text-white md:text-5xl">Política de privacidad</h1>
          </header>
          ...
          <div className="space-y-7 text-base leading-8 text-slate-200">
            ...
            <section>
              <p>
                Los datos de usuario no serán vendidos ni compartidos con terceros para fines comerciales, de
                marketing o de explotación de datos. La información se procesa únicamente en el marco de la
                operación de la plataforma y de los servicios técnicos necesarios para prestar la experiencia de
                uso, la seguridad y la autenticación del usuario.
              </p>
            </section>
