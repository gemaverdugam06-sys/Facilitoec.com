...
- [ ] Add client envs (VITE\_\*) in Vercel Project Settings (Preview/Production as needed).
- [ ] Add server-only envs (no VITE\_ prefix) as "Secret": `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_URL`.
